...
const categories = ["All", "Fullstack Web Development", "Graphic Design", "Branding", "Motion Design"];
      ...
      <div className="container mx-auto">
        <AnimatedSection className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-lg mx-auto">
            A showcase of my best work across Fullstack development, graphic design, branding, and motion design
          </p>
        </AnimatedSection>
