        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
          ...
          <AnimatedSection direction="right" className="space-y-6">
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                I'm a passionate Fullstack web developer and graphic designer based in Kenya, operating under the creative brand 
              ...
              <p>
                With expertise spanning Fullstack development and visual design, I bring a unique perspective to every project. 
