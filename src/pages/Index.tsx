          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              >
                Professional{" "}
                <TypingEffect
                  words={["Fullstack Web Developer", "Graphic Designer", "Brand Strategist"]}
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <AnimatedSection delay={0.1} direction="left">
              <div className="glass-card p-8 hover-lift group">
                ...
                <h3 className="font-display text-xl font-semibold mb-3">Fullstack Development</h3>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              },
              {
                ...
                text: "From branding to Fullstack web development, Kennedy handled everything with professionalism. The final product was polished, modern, and exactly what we needed.",
                stars: 4,
              },
            ].map((t, i) => (
